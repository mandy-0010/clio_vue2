...
<section>
 ...
 <div class="row bg-brown pb-5">
    ...
    <div class="col-5  bg-cover rounded ml-5"  style="background-image:url(https://images.unsplash.com/photo-1600364971552-381b40141177?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80)">
      
    </div>
    <div class="col-md-6 ">
     <div class="col-12 pb-5 p-lg-4 pl-md-1 offset-lg-2 ">
      
      <h6 class="text-white font-weight-bold lh-lg letter-spacing-1 ">客服電話:<span> 02-122-5678</span></h6>
      <h6 class="text-white font-weight-bold lh-lg letter-spacing-1 ">客服信箱:<span> clioservice@gmail.com</span></h6>
      <h6 class="text-white font-weight-bold lh-lg letter-spacing-1 ">客服時間:<span> 週一至週五：9:00 am - 18:00 pm</span></h6>
      <h6 class="text-white font-weight-bold lh-lg letter-spacing-1 ">Instgram：<span> @Clioaccessory</span></h6>
      <h6 class="text-white font-weight-bold lh-lg letter-spacing-1 ">Facebook：<span> Clioaccessory</span></h6>
...
<section>
  <div class="row  bg-brown pt-5">
    <div class="col-md-4 pb-5 pl-lg-4 ">
      ...
      <a href="#" class="text-decoration-none "><h6 class="text-white font-weight-bold">聯絡我們</h6></a>
    </div>
